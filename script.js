...
const IDENTITY_CATEGORIES = [
  ...
  { id: "gods", title: "神职", names: ["预言家", "女巫", "猎人", "白神", "通灵师", "守卫", "舞者", "魔术师", "定序王子", "毒师", "摄梦人", "蒙面人", "白夜使者", "禁言长老", "骑士", "守墓人", "杠精", "熊", "白泽"] },
  { id: "wolves", title: "小狼", names: ["狼人"] },
  { id: "special-wolves", title: "大狼", note: "带有特殊技能的狼人", names: ["机械狼", "假面", "诡术师", "狼王", "盗宝大师", "梦魇", "狼术师", "黑夜使者", "白狼王", "狼美人", "石像鬼", "典狱长", "隐狼", "九尾狐"] },
...
const IDENTITY_ART_MARGINS = {
  "熊": [16, 4, 16, 4], "蒙面人": [20, 5, 20, 5],
  "梦魇": [20, 5, 20, 5], "证婚人": [19, 4, 20, 4],
  "情侣": [20, 6, 21, 5],
...
const IDENTITY_FULL_BLEED = new Set(["诡术师", "九尾狐", "白泽"]);

function identityArtStyle(name) {
  if (IDENTITY_FULL_BLEED.has(name)) {
    return "--art-width:100%;--art-height:100%;--art-left:0%;--art-top:0%;--art-fit:cover;";
  }
